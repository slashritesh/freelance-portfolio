  ...
  return (
    <>
      <div className='Boxed '>
        ...
        <div className='flex sm:flex-col w-full'>
          ...
          <div className='flex justify-end flex-1'>
            <img className='rounded-xl sm:mt-10 w-[900px] sm:w-full ' src={heroimg} alt="Ritesh mane" />
      ...
      <div className='py-2 Boxed'>
        <hr />
        <div className='flex sm:flex-wrap justify-between p-5'>
        ...
        <div className='flex sm:gap-8 sm:flex-col my-20'>
          ...
          <div className='flex-1 pr-10 sm:p-0'>
            <i className=' text-slate-500'>
              "My name is Ritesh from India. I am working in this field last 2yr and also work with the co-opreate and freelance project <br />
              <br />
              ...
              <br /><br />also adding the automation and systems integartion which help bussiness to be productive and deliver services seamlessly
              "
              </div>
            </i>
...
const CalltoAction =()=>{
  return(
    <>
    <div className='Boxed py-2 pb-20 sm:pb-10 '>
      <div className='bg-blue-800 sm:h-fit bg-opacity-20 relative border border-blue-600 flex flex-col gap-5 rounded-2xl p-10'>
        <h1 className='p-2 bg-gray-600 w-fit sm:hidden rounded-full px-10'>Build online presence professional</h1>
        <div className='flex sm:flex-col justify-between items-center'>
        <h1 className='text-4xl  font-semibold sm:text-2xl sm:mb-10 '>Book a Call to get offer in Best Budget</h1>
        <button className='px-10 py-4 sm:p-3 rounded-2xl bg-indigo-600'> Connect into DM </button>
        </div>
      </div>
    </div>
    </>
  ...
  return (
    <>
      <div className='Boxed py-40 sm:py-36'>
        ...
        <div className='text-center justify-center gap-5 flex sm:flex-col p-5'>
          <p className='p-2 px-5 sm:text-sm bg-blue-950 rounded-full border border-blue-600'>✅ Professional design  &nbsp; &nbsp;</p>
          <p className='p-2 px-5 sm:text-sm bg-blue-950 rounded-full border border-blue-600'>✅ High converting   &nbsp; &nbsp;</p>
          <p className='p-2 px-5 sm:text-sm bg-blue-950 rounded-full border border-blue-600'>✅ Proven stategies</p>
        </div>
